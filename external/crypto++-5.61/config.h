...
// Force-disable all SIMD intrinsics for compatibility with MSVC 2015
#define CRYPTOPP_DISABLE_ASM 1
#define CRYPTOPP_DISABLE_SSE2 1
#define CRYPTOPP_DISABLE_SSE3 1
#define CRYPTOPP_DISABLE_SSSE3 1
#define CRYPTOPP_DISABLE_SSE4 1
#define CRYPTOPP_DISABLE_SSE41 1
#define CRYPTOPP_DISABLE_SSE42 1
#define CRYPTOPP_DISABLE_AVX 1
#define CRYPTOPP_DISABLE_AVX2 1
#define CRYPTOPP_DISABLE_AESNI 1
#define CRYPTOPP_DISABLE_SHA 1
...
typedef unsigned char byte;		//lwss - move to CryptoPP namespace to avoid C++17 errors
