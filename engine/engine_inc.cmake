...
if( WINDOWS )
    target_link_libraries(${OUTBINNAME} appframework bitmap dmxloader mathlib)
else()
...
if( NOT DEDICATED )
    if( WINDOWS )
        target_link_libraries(${OUTBINNAME} matsys_controls soundsystem_lowlevel)
    else()
...
if( WINDOWS )
    target_link_libraries(${OUTBINNAME} libtier0 tier2 tier3 vstdlib)
    target_link_libraries(${OUTBINNAME} vtf)
else()
...
if( NOT DEDICATED )
    if( WINDOWS )
        target_link_libraries(${OUTBINNAME} vgui_controls videocfg)
    else()
...
if( KISAK_USE_SDR )
    ...
    if( WINDOWS )
        # not sure why this is using .a instead of .lib bhut i'll leave it for now
        target_link_libraries(${OUTBINNAME} ${LIBPUBLIC}/steamdatagramlib.a) #Link with Evil Proprietary steamdatagram lib
    else()
        target_link_libraries(${OUTBINNAME} ${LIBPUBLIC}/steamdatagramlib_client.a) #Link with Evil Proprietary steamdatagram lib
    endif()
endif()
if( WINDOWS )
    target_link_libraries(${OUTBINNAME} bzip2)
else()
    target_link_libraries(${OUTBINNAME} bzip2_client)
endif()
if(NOT DEDICATED)
    if( WINDOWS )
        target_link_libraries(${OUTBINNAME} jpeglib)
    else()
...
if( WINDOWS )
    target_link_libraries(${OUTBINNAME} quickhull)
else()
    target_link_libraries(${OUTBINNAME} quickhull_client)
endif()
target_link_libraries(${OUTBINNAME} cryptopp-object)
